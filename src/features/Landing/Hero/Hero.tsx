...
export const Hero = () => {
  ...
  return (
    <section className="hero relative w-screen h-screen">
      ...
      <img
        id="logo-icon"
        className="absolute top-14 left-14 z-20"
        width={120}
        height={120}
        src={LogoIcon}
        alt="logo icon"
      ...
      <h1 className="text-9xl font-gibed text-c-light-gray  w-max absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-40">
        Move. Train. Succeed.
      </h1>
      <div className="mouse absolute left-1/2 bottom-4 transform -translate-x-1/2 z-40">
        <div className="mouse-icon">
          <span className="mouse-wheel"></span>
        </div>
      </div>
      <div className="line top-h  z-20"></div>
      <div className="line left-v z-20"></div>
      <div className="line right-v z-20"></div>
      <div className="line bottom-h  z-20"></div>
      <img src={CrossSVG} className="cross absolute top-h left-v z-20" alt="cross-svg" />
      <img src={CrossSVG} className="cross absolute top-h right-v z-20" alt="cross-svg" />
      <img src={CrossSVG} className="cross absolute bottom-h left-v z-20" alt="cross-svg" />
