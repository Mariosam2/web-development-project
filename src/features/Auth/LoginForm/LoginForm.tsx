    ...
    <form className="pt-8" onSubmit={handleSubmit(onSubmit)}>
      <div className="form-group">
        ...
        <input
          ...
          className={`bg-white border w-full border-c-gray  text-c-dark text-base rounded-xl p-2.5 focus:outline-none focus:border-c-yellow-500 focus:shadow-[0_0_0_3px_rgba(243,255,150,0.2)] transition-all duration-200 ${errors.identifier ? "border-red-500" : ""}`}
        />
        <span
