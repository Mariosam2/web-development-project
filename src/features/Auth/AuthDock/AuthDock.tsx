  ...
  return (
    <>
      <div className="container-xs relative dock w-full rounded-2xl bg-c-gray  c-shadow-md text-c-dark grid grid-cols-2 ">
        ...
        />
        <NavLink to="/login" className="sign-in relative z-20  p-3  text-lg text-center rounded-2xl cursor-pointer">
          Sign in
        </NavLink>
        <NavLink to="/signup" className="sign-up  relative z-20 p-3  text-lg text-center rounded-2xl cursor-pointer">
          Signup
        </NavLink>
      </div>
    </>
