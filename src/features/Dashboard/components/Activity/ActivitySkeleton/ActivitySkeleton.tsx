      ...
      <div className="flex flex-col px-4 sm:px-6 lg:px-8">
        <div className="statistic pb-12 xl:pb-0 xl:px-0 grid grid-cols-1 sm:grid-cols-6 gap-3 md:grid-cols-6 xl:gap-4">
          {[...Array(3)].map((_, i) => (
            <div
              key={i}
              className="col-span-1 sm:col-span-2 border border-c-gray/20 grid place-items-center rounded-2xl bg-white/70 backdrop-blur-md c-shadow-premium p-4 gap-3">
          ...
          <div className="calendar col-span-1 sm:col-span-6 lg:col-span-3 border border-c-gray/20 rounded-2xl bg-white/70 backdrop-blur-md c-shadow-premium row-span-4 p-4 flex flex-col gap-3 h-110">
            <div className="h-5 w-24 rounded-lg bg-gray-200 animate-pulse" />
          ...
          <div className="bars-chart col-span-1 sm:col-span-6 lg:col-span-3 border border-c-gray/20 rounded-2xl bg-white/70 backdrop-blur-md c-shadow-premium p-0 xl:p-4 row-span-4 flex flex-col h-110">
