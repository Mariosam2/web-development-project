...
export const exerciseApi = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    getExercises: builder.query<IApiResponse<IExerciseOverview[]>, IExerciseQuery>({
      query: (params) => ({
        url: `${import.meta.env.API_PREFIX}/exercises`,
        method: "GET",
        params,
      }),
      providesTags: ["Exercises"],
    }),
    getSingleExercise: builder.query<IApiResponse<IExerciseOverview[]>, { exerciseId: string }>({
      query: ({ exerciseId }) => ({
        url: `${import.meta.env.API_PREFIX}/exercises/${exerciseId}`,
        method: "GET",
      }),
      providesTags: ["Exercises"],
    }),
    getBodyParts: builder.query<IApiResponse<IBodyPart[]>, void>({
      query: () => ({
        url: `${import.meta.env.API_PREFIX}/exercises/body-parts`,
        method: "GET",
      }),
    ...
    getTargetMuscles: builder.query<IApiResponse<ITargetMuscle[]>, void>({
      query: () => ({
        url: `${import.meta.env.API_PREFIX}/exercises/target-muscles`,
        method: "GET",
      }),
    ...
    getExerciseTypes: builder.query<IApiResponse<IExerciseType[]>, void>({
      query: () => ({
        url: `${import.meta.env.API_PREFIX}/exercises/types`,
        method: "GET",
      }),
